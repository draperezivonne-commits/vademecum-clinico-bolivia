/* Vademécum Clínico Bolivia v0.20.11 · seguridad de presentación de interacciones */
(function(){
  ...
  if(about)about.innerHTML=about.innerHTML.replace(/Aplicación\s+0\.20\.\d+/,'Aplicación 0.20.11');
  window.VCB_INTERACTION_UI_VERSION='0.20.11';
})();
